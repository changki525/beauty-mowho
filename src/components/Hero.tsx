...
const buttons = [
  ...
  { label: '카카오톡', href: 'https://open.kakao.com/o/sYRluBCf', icon: 'M12 3C6.48 3 2 6.58 2 11c0 2.83 1.88 5.31 4.7 6.72-.16.58-.58 2.12-.67 2.45-.1.41.15.4.32.29.13-.09 2.09-1.4 2.94-1.97.88.13 1.78.2 2.71.2 5.52 0 10-3.58 10-8S17.52 3 12 3z' },
